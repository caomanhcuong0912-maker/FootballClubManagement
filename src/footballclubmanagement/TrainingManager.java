...
public class TrainingManager {
    ...
    private PlayerManager playerManager; // TODO: Object -> PlayerManager
    ...
    public TrainingManager(PlayerManager pm) { // TODO: Object -> PlayerManager
        this.trainingSessions = new ArrayList<>();
        this.playerManager    = pm;
    }

    public void setPlayerManager(PlayerManager pm) { // TODO: Object -> PlayerManager
        this.playerManager = pm;
    }
    ...
    if (playerManager == null) {
        System.out.println("PlayerManager not set.");
        return null;
    }
    return playerManager.getActivePlayerIds(); // ← now works with real PlayerManager
}
}
